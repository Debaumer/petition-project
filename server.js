...
function confirmPassword(initial, confirmation) { //todo
  return new Promise
}
...
app.get("/thankyou", (req, res) => {
    var results = db.selectAll().then(result => {
      console.log(results);
      return results;
    }).catch(err => {
      console.log(err);
...
app.post("/", (req, res) => {
  ...
  db.createUser(req.body.firstName, req.body.lastName, req.body.email, password, req.body.signature)
    .then(values => {
